import { ArrowLeft, Camera, ChevronDown, Calendar } from "lucide-react"
      ...
      <div className="bg-gradient-to-b from-[rgba(6,11,40,0.74)] to-[rgba(10,14,35,0.71)] rounded-lg p-6 mb-6">
        <div className="flex items-center gap-6">
          <div className="relative">
            <div className="w-24 h-24 rounded-full bg-gray-300 border-4 border-[#c75e8a]/30">
              {/* Profile image placeholder */}
            </div>
            <button className="absolute bottom-0 right-0  bg-gradient-to-r from-[#FF0844] to-[#0075FF] p-1.5 rounded-full">
